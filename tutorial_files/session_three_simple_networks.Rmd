---
title: "Session 3 – Microbiome–Diet-SCFA Co-occurrence Network"
subtitle: "SPIEC-EASI networks of metagenome abundance and SCFAs"
output:
  html_document:
    toc: true
    toc_float: true
...
Here we build the same type of network from scratch on the data we have been using today, which is much smaller. 
...
- **Matrix A** - microbiome features (same species OTU table as sessions 1 & 2)
- **Matrix B** - SCFAs 
...
```{r node-setup, include = TRUE, echo=TRUE, results = 'hide'}
...
```{r netcomi-plot, fig.width=14, fig.height=7}
plot(
  net_props,
  sameLayout   = TRUE,
  layoutGroup  = "union",
  ...
  nodeSizeSpread = 1.5,
  nodeColor    = "feature",
  colorVec     = list(unname(BIO_COLORS_4), unname(BIO_COLORS_4)),
